...
To use the Free Bike Pack, you can simply drag the model (in folder "Models") or the prefab (in folder "Prefabs") into the scene.


LICENSE

Thank you for downloading the Free Bike Pack! 
...
Among all reviews we will raffle another package from us.
